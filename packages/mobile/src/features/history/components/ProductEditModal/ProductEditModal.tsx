    ...
    >
      <SafeAreaView className="flex-1 bg-background" edges={['top', 'left', 'right']}>
        ...
        >
          ...
          >
            <View className="flex-row items-center justify-between px-4 py-4 min-h-[56px] bg-gray-900/40">
              <Pressable
                onPress={onClose}
                className="w-10 h-10 items-center justify-center rounded-full bg-white/10"
                hitSlop={{ top: 15, bottom: 15, left: 15, right: 15 }}
              >
                <Icons.Close size={20} color="#ffffff" />
              </Pressable>
              <Text className="text-white text-lg font-semibold">Bearbeiten</Text>
              <Pressable
                onPress={handleSave}
                className="px-5 py-2.5 rounded-full bg-primary-500"
